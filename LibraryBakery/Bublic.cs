...
namespace LibraryBakery
{
	...
	public class Bublic : Bakery
	{
		...
		/// Markup for price
		/// </summary>
		private static double markup = 1.9;
		...
		public Bublic(string[] data_line, double Weight, double Price, double Calorie, int Numerous)
		...
		{
			return String.Format("Бублик: {0} штук\nМасса: {1} кг\n" +
