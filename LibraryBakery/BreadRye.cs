...
namespace LibraryBakery
{
	...
	public class BreadRye : Bakery
	{
		...
		public BreadRye(string[] data_line, double Weight, double Price, double Calorie, int Numerous)
		...
		{
			return String.Format("Хлеб ржаной: {0} штук\nМасса: {1} кг\n" +
		...
		public override bool Equals(object obj)
		{
			if (obj == null)
				return false;
			BreadRye B = obj as BreadRye;
			if (B as BreadRye == null)
				return false;
