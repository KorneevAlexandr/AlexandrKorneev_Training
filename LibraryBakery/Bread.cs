...
namespace LibraryBakery
{
	...
	public class Bread : Bakery
	{
		...
		/// Markup for price
		/// </summary>
		private static double markup = 1.8;
		...
		public Bread(string[] data_line, double Weight, double Price, double Calorie, int Numerous)
		...
		{
			return String.Format("Хлеб: {0} штук\nМасса: {1} кг\n" +
