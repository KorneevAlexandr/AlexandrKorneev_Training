...
namespace LibraryBakery
{
	...
	public class Bun : Bakery
	{
		...
		/// Markup for price
		/// </summary>
		private static double markup = 1.3;
		...
		public Bun(string[] data_line, double Weight, double Price, double Calorie, int Numerous)
		...
		{
			return String.Format("Булка: {0} штук\nМасса: {1} кг\n" +
